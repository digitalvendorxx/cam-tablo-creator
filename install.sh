...
#   curl -fsSL https://raw.githubusercontent.com/esenbora/etsy-cam-tablo/release/install.sh | bash
# Ozel hedef:
...
REPO_URL="https://github.com/esenbora/etsy-cam-tablo.git"
BRANCH="${BRANCH:-release}"
TARGET_DIR="${1:-$HOME/etsy-cam-tablo}"

echo "=== Cam Tablo Creator - tek satir kurulum ==="
...
Sirayla:
  ...
  "Cam Tablo Creator.command" dosyasina sag tik > Open
...
Tek tik kullanim icin:
  Mac:    Finder'da Cam Tablo Creator.command dosyasina cift tik
